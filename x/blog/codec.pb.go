...
type Article struct {
	...
	DeleteTaskID int64 `protobuf:"varint,11,opt,name=delete_task_id,json=deleteTaskId,proto3" json:"delete_task_id,omitempty"`
}
...
func (m *Article) GetDeleteTaskID() int64 {
	if m != nil {
...
var fileDescriptor_87ea59410c2fea68 = []byte{
	...
	0x69, 0xde, 0x50, 0x92, 0xd7, 0xb0, 0x99, 0xd5, 0x90, 0x34, 0x9a, 0x8e, 0x99, 0x6f, 0x35, 0x92,
	0x42, 0xad, 0x78, 0xd5, 0x69, 0xee, 0x24, 0xbf, 0xec, 0xd1, 0x68, 0xfa, 0x76, 0xc7, 0x6d, 0xfa,
	...
	0xd7, 0x26, 0xeb, 0xc9, 0xc7, 0xf0, 0xd5, 0xef, 0x00, 0x00, 0x00, 0xff, 0xff, 0x79, 0x5e, 0x8f,
	0xfe, 0x4b, 0x07, 0x00, 0x00,
}
...
func (m *Article) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DeleteTaskID != 0 {
		dAtA[i] = 0x58
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.DeleteTaskID))
	}
	return i, nil
}
...
func (m *Article) Size() (n int) {
	...
	if m.DeleteTaskID != 0 {
		n += 1 + sovCodec(uint64(m.DeleteTaskID))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 11:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DeleteTaskID |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
